...
mirek stop */
                    ...
                    iceServers: [{urls: 'stun:193.1.28.4'}]
    ...
    var IceServersHandler = (function() {
        function getIceServers(connection) {
            var iceServers = [];
/* mirek start */
//              iceServers = [{url:'stun:stun.xten.com'},{url: 'turn:numb.viagenie.ca', credential: 'muazkh', username: 'webrtc@live.com'}];
		iceServers = [{url:'stun:193.1.28.4'},{url: 'turn:193.1.28.6:443?transport=tcp', credential: 'cisco', username: 'cisco'}];
        ...
        function handle(connection) {
            ...
            connection.onFileEnd = function(file) {
                ...
                if (file.type.indexOf('image') != -1) {
                    div.innerHTML = '<a href="' + file.url + '" download="' + file.name + '>' + file.name + '</a><br /><img src="' + file.url + '" title="' + file.name + '" style="max-width: 80%;">';
                } else {
